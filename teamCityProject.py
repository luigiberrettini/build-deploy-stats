...
class TeamCityProject:
    ...
    def _url_of_build_configurations(self, skip, limit):
        locator_query_string_fragment = 'locator=affectedProject:%s,start:%d,count:%d' % (self.project_id, skip, limit)
        ...
        return '%s?%s' (self.api_proxy.full_url_from_resource_url('buildTypes'), query_string)